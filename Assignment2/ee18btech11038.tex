...
\begin{figure}
\label{fig3}
\includegraphics[width = 15cm]{./figs/iir-lowpass-analog.eps}
\caption{The magnitude response plot for the analog lowpass IIR filter obtained from Equation \ref{lpfinal}}
\end{figure}
